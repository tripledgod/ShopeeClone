...
import { ErrorResponse } from 'src/types/utlis.type'
import { setProfileToLS } from 'src/utlis/auth'
import { userSchema, UserSchema } from 'src/utlis/rules'
import { getAvatarUrl, isAxiosUnprocessableEntityError } from 'src/utlis/utlis'
        ...
        <form className='mt-8 flex flex-col-reverse md:flex-row md:items-start' onSubmit={onSubmit}>
          ...
          <div className='flex justify-center md:w-72 md:border-l md:border-l-gray-200'>
            <div className='flex flex-col items-center'>
              ...
              <InputFile onChange={handleChangeFile} name={''} />
